...
class ArucoControl(Node):
    ...
    def send_box_data(self, marker_id, translation, quaternion):
        ...
        # Open the CSV file for writing marker data.
        filename = f"data_{marker_id}.csv"
        data = [translation[0], translation[1], translation[2], quaternion[0], quaternion[1], quaternion[2], quaternion[3]]
