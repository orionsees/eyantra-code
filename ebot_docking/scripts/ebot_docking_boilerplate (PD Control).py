...
class MyRobotDockingController(Node):
    def __init__(self):
        ...
        self.ORIENTATION_D_GAIN = 0.1  
        self.LINEAR_D_GAIN = 0.1  
    ...
    def controller_loop(self):
        ...
        if self.state == "ALIGNMENT":
            ...
            angular_error_derivative = (error_angular - self.prev_angular_error) / dt
            print(f"{target_angle} - {current_angle} = {error_angular}")

            wt = (self.ORIENTATION_P_GAIN * error_angular) + (self.ORIENTATION_D_GAIN * angular_error_derivative)
