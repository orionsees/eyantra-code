...
class MyRobotDockingController(Node):
    def __init__(self):
        ...
        self.imu_sub = self.create_subscription(Odometry, '/odom_fused', self.imu_callback, 10) 
        ...
        # Variables
        self.ORIENTATION_THRESHOLD = math.radians(4)  # Orientation alignment tolerances (in radians)
        self.DISTANCE_THRESHOLD = 0.02    # Distance thresholds (in meters)
        
        # P-Controller Values
        self.ORIENTATION_P_GAIN = 2.5            
        self.LINEAR_P_GAIN = 1.5
    ...
    def controller_loop(self):
        ...
        if self.state == "ALIGNMENT":
            direction = math.copysign(1, self.robot_pose[2])
